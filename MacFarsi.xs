...
#define FromMacTbl	fm_macfa_tbl
#define FromMacDir	fm_macfa_dir
#define ToMacTbl 	to_macfa_table
#define ToMacTblN	to_macfa_N
#define ToMacTblL	to_macfa_L
#define ToMacTblR	to_macfa_R
